...
Plans:
- [ ] 03-01-PLAN.md — Tracer: one slot end to end, then the full 16-slot registry (7 locations, 9 characters), priority ranking and the voice key
...
| 3. Asset Management & Manifest | 0/3 | Planned | - |
